<template>
  <v-app>
    <v-app-bar>
      <v-app-bar-title>View</v-app-bar-title>
      ...
      <v-container>
        <v-sheet max-width="800" class="mx-auto mt-10">
          <v-card class="mx-auto mt-16" max-width="800">
            ...
            <v-card-text>
              <v-textarea label="제목" variant="outlined" rows="1"></v-textarea>
              <v-textarea
                label="내용을 입력하세요"
                variant="outlined"
                rows="15"
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn @click="btnList">back</v-btn>
              <v-btn @click="btnWrite" color="primary">Write</v-btn>
            </v-card-actions>
          </v-card>
        </v-sheet>
      </v-container>
